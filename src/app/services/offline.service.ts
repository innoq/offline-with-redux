...
export class OfflineService {
    ...
    handleOfflineError<Type>(error: Error, args: { defaultValue: Type }): Observable<Type> {
    ...
    resendRequest(req: HttpRequest<any>): Observable<any> {
        return this.http.request(req.method, req.url, { headers: req.headers, body: req.body });
    }
}
